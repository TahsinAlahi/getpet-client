...
function Login() {
  ...
  return (
    <main className="bg-primary dark:bg-dark-primary min-h-screen max-w-screen-xl mx-auto text-black dark:text-white font-openSans">
      <h1 className="text-3xl pt-6 border-b-2 border-black dark:border-secondary  mx-auto text-center w-fit pb-1 mb-10 lg:mb-2 font-nunito">
        Login
      </h1>
